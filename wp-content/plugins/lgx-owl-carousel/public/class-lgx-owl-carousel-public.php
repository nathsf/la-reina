...
class Lgx_Owl_Carousel_Public {
	...
	public function lgx_carousel_shortcode_function($atts) {
		...
		//$animateout_set = ( !empty($animateout_set) && !is_null($animateout_set) && ($animateout_set == 'yes') ) ? 'true' : 'false';
		...
		//$animatein_set  = ( !empty($animatein_set) && !is_null($animatein_set) && ($animatein_set == 'yes') ) ? 'true' : 'false';
